...
#define NR_LIB_CSV_H
    ...
    #include <c4d.h>
        ...
        /* From R15.020 c4d_misc/utilities/apibasemath.h */
    ...
    /**
     * Extension of the c4d_misc::BaseArray class implementing the retrieving
     * of default values.
     */
    template <typename T>
    class DefaultBaseArray : public c4d_misc::BaseArray<T> {

        typedef c4d_misc::BaseArray<T> super;
